...
#ifndef TEMPLATE_EXPLORATION_VIEW_H
#define TEMPLATE_EXPLORATION_VIEW_H
...
public slots:
    ...
    void saveGeneralSettings(QTextStream& _out);
    
signals:
    
    void selectedPointChanged(double, double);
    
    void hoveredPointChanged(double, double);
...
private:
    ...
    std::vector<QPointF> clickedPoints_;
    
    std::vector<QPointF> hoveredPoints_;
};
